...
<div class="card-body">
<form class="form-horizontal" action="/update/{{$items->id}}" method="post" enctype="multipart/form-data">
  @csrf
...
<input type="text" id="name4" value="{{$items->Author}}" name="author" class="form-control" placeholder="Author">
</div>
@error('author')
...
<div class="input-group">
<input type="text" value="{{$items->Content}}" id="name5" name="content" class="form-control" placeholder="Content">
<span class="input-group-addon">
...
<input type="text" value="{{$items->Title}}" id="username4" name="title" class="form-control" placeholder="title">
</div>
@error('title')
<p class="text-danger">{{$message}}</p>
@endError
...
<div class="form-group row">
        ...
        <textarea class="form-control" id="query1" name="description" rows="4" placeholder="Your Query">{{$items->Description}}</textarea>
        </div>
        @error('description')
        <p class="text-danger">{{$message}}</p>
    @endError
...
<div class="form-group row">
<div class="col-lg-10  ml-auto">
<button class="btn btn-primary l" type="submit">Update</button> --}}
{{-- <button class="btn btn-warning layout_btn_prevent">Cancel</button> --}}
{{-- </div>
</div>
</fieldset>
